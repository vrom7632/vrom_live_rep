...
if __name__ == "__main__":
    ...
    for i in range(0,episode_count):
        ...
        if i == 0:
            ...
            ani.save("meirotansaku_katihanpukuhou_greedy_1_gakushumae.mp4", writer="ffmpeg")
        elif (i + 1) % 10 == 0:
            ani = agent_animation(s_a_history, fig, line)
            ani.save("meirotansaku_katihanpukuhou_greedy_2_gakushuchu_{}.mp4".format(i), writer="ffmpeg")
            
    # print("count:{}".format(count))
    # 迷路探索のアニメーション描画
    ani = agent_animation(s_a_history, fig, line)
    ani.save("meirotansaku_katihanpukuhou_greedy_3_gakushugo.mp4", writer="ffmpeg")
